...
INSERT INTO "new_WorkflowState" ("description", "id", "isFinal", "isInitial", "name", "order", "projectId") SELECT "description", "id", "isFinal", "isInitial", "name", "order", "projectId" FROM "WorkflowState";
