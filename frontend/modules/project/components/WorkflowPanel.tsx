          ...
          {sortedStates.map((s) => (
            <div key={s.id} className="border border-slate-200 rounded-xl p-4 bg-white">
              <div className="flex items-center justify-between gap-3">
                ...
                {/* Delete button removed as endpoint doesn't exist */}
              </div>

              <div className="mt-4 grid grid-cols-2 gap-3 opacity-60 cursor-not-allowed">
                <label className="flex items-center gap-2 text-xs text-slate-600">
                  <input
                    type="checkbox"
                    checked={!!s.isInitial}
                    disabled // onChange={(e) => patch(s, { isInitial: e.target.checked })}
                  />
                  Initial
                </label>
                <label className="flex items-center gap-2 text-xs text-slate-600">
                  <input
                    type="checkbox"
                    checked={!!s.isFinal}
                    disabled // onChange={(e) => patch(s, { isFinal: e.target.checked })}
                  />
                  Final
                </label>
                <label className="flex items-center gap-2 text-xs text-slate-600">
                  <input
                    type="checkbox"
                    checked={!!s.isDefault}
                    disabled // onChange={(e) => patch(s, { isDefault: e.target.checked })}
                  />
                  Default
                </label>
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    disabled // onChange={(e) => patch(s, { color: e.target.value })}
                ...
                <div className="col-span-2 flex items-center gap-2">
                  ...
                  <input
                    ...
                    // }}
                    className="flex-1 px-3 py-2 rounded-lg border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50"
                  />
                </div>
                <div className="col-span-2 flex items-center gap-2">
                  ...
                  <input
                    ...
                    // }}
                    className="w-24 px-3 py-2 rounded-lg border border-slate-200 text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-slate-50"
                  />
                </div>
              </div>
            </div>
