...
El sistema DEBE ejecutar los tests automáticamente antes de permitir un commit.
...
Los tests DEBEN ejecutarse completamente antes de confirmar la depuración.
...
Los tests que se ejecutan en pre-commit DEBEN incluir validación de TypeScript y tests unitarios.
...
La configuración de pre-commit DEBE almacenarse en la raíz del proyecto.
...
Los desarrolladores DEBEN poder saltarse los tests en caso de emergencia usando `--no-verify`.
