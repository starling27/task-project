...
El proyecto DEBE configurarse como un npm workspace con dos paquetes independientes: `frontend/` y `backend/`.
...
El proyecto DEBE mantener frontend y backend en carpetas independientes con sus propios `package.json`.
...
Las dependencias específicas de cada proyecto DEBEN residir en su respective `package.json`.
...
Cada proyecto DEBE poder compilarse de forma independiente.
...
La configuración base de TypeScript DEBE residir en la raíz y extenderse en cada proyecto.
